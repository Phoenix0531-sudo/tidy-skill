...
REQUIRED_SKILL_FILES = [
    ...
    "scripts/install-rule-template.ps1",
    "hooks/stop-hygiene-check.py",
    "hooks/session-hygiene-reminder.md",
    "hooks/HOOKS.md",
    "commands/TRIGGERS.md",
    "commands/tidy.md",
    "commands/tidy-score.md",
    "commands/audit-artifacts.md",
    "commands/tidy-doctor.md",
    "commands/classify-path.md",
    "references/tidy-skill.policy.example.json",
